        ...
        return(
            <div>
                ...
                <div className="contianer-sidebar-content">
                    ...
                    <div className="row">
                        <div className="col-md-3 col-sm-3 col-xs-12 col-lg-3" id="overview-sidebar">
                            <div className="col-md-12 col-sm-12 col-xs-12" id="status-sidebar">
                                <span className="pull-left">Status</span>
                                <span className="genicon-barchart pull-right"></span>
                            </div>

                            <div className="overview-pg-indicator">
                                ...
                                <div className="col-md-12" id="percentage_comp_div">
                                    ...
                                    <p id="project_stats">
                                    <span className="genicon-manatwork-compact text-task-lightgreen">
                                    </span>In progress: (4 tasks Ongoing, 50%)
                                    </p>
                                    ...
                                    <p id="project_stats">
                                    <span className="genicon-exclamation-compact text-task-red">
                                    </span>Late/problematic: (0 tasks, 0%)
                                    </p>
                            ...
                            <div className="task-list-parent-div">
                                ...
                                <div className="completed-tasks">
                                    <p className="tc" ><span class="genicon-task-hammer"></span>
                                        <span className="genicon-tick-solid tick"></span>  4 Tasks Completed</p>
                                    <div className="row">
                                        <div id="tittle-competed-task" className="col-md-4 col-xs-2">Task Name</div>
                                        <div id="tittle-competed-task" className="col-md-2 col-xs-3">Start Date</div>
                                        <div id="tittle-competed-task" className="col-md-2 col-xs-2">Completion Date</div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div id="completed-task-table" className="col-md-2 col-xs-2">
                                            <span className="genicon-tick-dotted text-task-blue bidii-tick-solid"></span> 15/Jan/2016
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div id="completed-task-table" className="col-md-2 col-xs-2">
                                            <span className="genicon-tick-solid text-task-blue bidii-tick-solid"></span> 21/Feb/2016</div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div id="completed-task-table" className="col-md-2 col-xs-2">
                                            <span className="genicon-tick-solid text-task-blue bidii-tick-solid"></span> 1/March/2016</div>
